...
@section('content')
	...
	<div class="row Eixo__container">
		<div class="Eixo__marine">
		<h2 class="Eixo__titulo">A QUEDA DO MURO</h2>
			<h3 class="Eixo__sub">Cidade unificada</h3>
			<p class="Eixo__texto">A cidade que vamos construir juntos será unificada em tratamento e em benefícios de forma igualitária, com investimentos, obras e políticas públicas que atendam a todos os bairros. A divisão entre centro, beira-mar e bairros que atualmente existe, vai acabar, implementaremos uma gestão para uma cidade única.
			</p>
		</div>
		<div class="Eixo__azul">
			<h2 class="Eixo__titulo">GOVERNO DECENTE </h2>
